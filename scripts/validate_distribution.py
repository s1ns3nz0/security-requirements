...
TRUSTED_WORKFLOW_SCRIPTS = {
    ...
    "apply_overlay.py",
    "axis_coverage.py",
    "aws_blast_snapshot.py",
    "blast_radius.py",
    "build_blast_graph.py",
    "classify_resp.py",
    "confirmation.py",
    "eval_golden.py",
    "lint.py",
    "kubernetes_attack_paths.py",
    "kubernetes_cloud_iam.py",
    "kubernetes_detection.py",
    "kubernetes_graph.py",
    "kubernetes_inputs.py",
    "kubernetes_mesh.py",
    "kubernetes_requirements.py",
    "kubernetes_runtime_snapshot.py",
    "kubernetes_supply_chain.py",
    "merge.py",
    "mutate.py",
    "profile_locale.py",
    "profile_schema.py",
